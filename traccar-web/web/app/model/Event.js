    ...
    fields: [{
        ...
        convert: function (v, rec) {
            ...
            if (rec.get('geofenceId')) {
			   ...
			   if (rec.get('positionId')) {
                posi = Ext.getStore('Positionss').getById(rec.get('positionId'));
                if (posi) {
                    text += ' "' + posi.get('address') + '"';
                }
            }
        ...
        depends: ['type', 'attributes', 'geofenceId', 'maintenanceId', 'positionId']
    }, {
        name: 'attributes'
    }]
});
