(function () {
    ...
    addStyleFile('charts-all.css');

    addStyleFile('//use.fontawesome.com/releases/v' + fontAwesomeVersion + '/css/all.css');

    addStyleFile('https://cdnjs.cloudflare.com/ajax/libs/ol3/3.17.1/ol.css');
	    addStyleFile('https://rawgit.com/walkermatt/ol3-layerswitcher/master/src/ol3-layerswitcher.css');
	    addStyleFile('https://rawgit.com/walkermatt/ol3-layerswitcher/master/examples/layerswitcher.css');
	    addStyleFile('https://rawgit.com/walkermatt/ol3-popup/master/src/ol3-popup.css');

		addStyleFile('https://cdnjs.cloudflare.com/ajax/libs/ol3/3.17.1/ol.js');

			addStyleFile('https://rawgit.com/walkermatt/ol3-layerswitcher/master/src/ol3-layerswitcher.js');

				addStyleFile('https://rawgit.com/walkermatt/ol3-popup/master/src/ol3-popup.js');

					addStyleFile('mapp.js');
					
										addStyleFile('tes.css');
    ...
    window.Images = ['arrow', 'offroad', 'truck'];
